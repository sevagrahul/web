...
<div class="login-box">
    ...
    <div class="login-logos">
  	...
  	<div class="login-box-body">
    	<h4 class="login-box-msg" style="font-weight: bold; color: #3D6245; font-size: 20px;">CLAIDAS ATTENDANCE SYSTEM</h4>
          ...
          <div class="form-group" style="display: none;">
            <select class="form-control" name="status" id="status" onchange="displayDiv('hideValueOnSelect', this)">
      		...
      		<div class="form-group has-feedback">
        		<input type="text" class="form-control input-lg" id="reference" pattern="[A-Za-z0-9]{1,15}" onkeyup="this.value = this.value.toUpperCase();"autocomplete="off" name="reference" placeholder="Employee ID" required style=" font-size: 20px;">
