							 ...
							 <tbody>
							 	...
							 	<tr>
									<td><?php echo $cnt;?></td>
							 		...
							 		<td><?php echo $result['typesofleaves']; ?></td>
				...
				<div class="modal-body">
					<form action="" method="post">
						<div class="form-group">
							...
							<label class="form-control-label">Type of leaves</label>
							<select name="typesofleaves" class="form-control" >
...
<?php
	if (isset($_POST['apply'])){
		...
		$typesofleaves = $_POST['typesofleaves'];
		$leavedate = $_POST['leavedate'];
		$todate = $_POST['todate'];
		$editor1 = $_POST['editor1'];
		$status = $_POST['status'];

		$sql = "INSERT INTO leaves(name,email,department,typesofleaves,leavedate,todate,leavereason,status)VALUES('$name','$email','$department','$typesofleaves','$leavedate','$todate','$editor1','$status')";
