...
$sql = "SELECT id, firstName, lastName, email, designation, dept, role, experience FROM employee, rank WHERE rank.eid = employee.id";
...
<body>
    ...
    <!-- Main content for the leaderboard -->
    <div id="main-content">
        ...
        <!-- <a href="reset.php" class="btn btn-reset">Reset Points</a> -->
    </div>
</body>
</html>
